  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary bg-blue-300 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
              ...
              >
                ...
                <SelectContent className="bg-white">
                  {selectItems.map((selectItems) => (
                    <SelectItem value={selectItems.value}>
                      {selectItems.label}
                    </SelectItem>
                  ))}
                </SelectContent>
